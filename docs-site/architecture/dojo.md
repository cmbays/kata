...
|---------------------|--------|
| Kansatsu data enriches diary entries and session content | Planned follow-on work |
| Frictions become prime diary content; prediction calibration feeds ushiro direction | Planned follow-on work |
| LLM synthesis could replace template-based section generation (v2 upgrade path) | Planned follow-on work |
| Belt data feeds a "progress" section type | Planned follow-on work |
