...
| Kansatsu (observation) system | 7-type observation schema at all hierarchy levels |
| Bunkai (knowledge) graph | Citation-based learnings with reinforcement and versioning |
| Kataka agent wrappers | Methodology-aware AI agent identities |
| Belt progression | Kyū/dan ranking from accumulated practice |
