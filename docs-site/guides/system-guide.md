...
- Builds a bunkai (knowledge) graph that improves agents over time
...
| `kata kansatsu` | `kata observe` | Record runtime kansatsu (observations) |
| `kata kataka` | `kata agent` | Manage kataka (agents) |
| `kata kotoba` | `kata lexicon` | Interactive vocabulary table |
